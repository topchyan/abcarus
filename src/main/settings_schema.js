...
function getSettingsSchema() {
  ...
  return [
    ...
    },
    {
      ...
      help: "Font family used for the app UI (does not affect the native OS menu bar). Leave empty to use the default.",
    ...
    },
    {
      ...
      groupOrder: 5,
      label: "UI font size",
      help: "Font size for the app UI (does not affect the editor or the rendered score).",
