...
function getSettingsSchema() {
  ...
  return [
    ...
    },
    {
      ...
      help: "Optional override for the Library tree (leave empty to inherit UI font).",
    ...
    },
    {
      ...
      help: "Optional override for the Library tree font size (px). Use 0 to inherit.",
      ui: { input: "number", min: 0, max: 40, step: 1 },
    },
    {
