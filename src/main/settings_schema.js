...
function getSettingsSchema() {
  ...
  return [
    ...
    },
    {
      ...
      group: "Zoom",
      groupOrder: 10,
      label: "Scale Editor and Score automatically",
      help: "Refits the Editor and Score when the window, Split divider, Library, or Set List changes the available space.",
      ui: { input: "checkbox" },
    },
    {
      key: "scoreFitMode",
      ...
      groupOrder: 10,
      label: "Score fit",
      help: "Notation width favors larger readable music; page width keeps the complete rendered page inside the pane.",
      ui: {
        input: "select",
        options: [
          { value: "content", label: "Notation width" },
    ...
    },
    {
      ...
      help: "Enables experimental makam/perde/EDO-53 tools, including Intonation Explorer and Bolahenk/concert conversion. Disabled by default for most users.",
      ui: { input: "checkbox" },
      advanced: true,
    },
    {
      key: "libraryRichTooltips",
      type: "boolean",
      default: true,
      section: "Library",
      group: "Interface",
      groupOrder: 20,
      label: "Show detailed Library tooltips",
      help: "Show file, group, and tune metadata when hovering over Library entries.",
      ui: { input: "checkbox" },
    },
    {
    ...
    },
    {
      ...
      groupOrder: 20,
      label: "Port",
      help: "Local network port used by ABCarus Mobile. Takes effect the next time sharing starts.",
      ui: { input: "number", min: 1024, max: 65535, step: 1 },
    },
    {
      key: "mobileLibraryCode",
      type: "string",
      default: "",
      section: "Library",
      group: "Mobile sharing",
      groupOrder: 20,
      label: "Password",
      help: "Password used by ABCarus Mobile. Leave empty to generate one automatically.",
