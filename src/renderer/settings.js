...
const FALLBACK_SCHEMA = [
  ...
  { key: "supportMicrotonalNotation", type: "boolean", default: false, section: "Tools", group: "Microtonal notation", groupOrder: 5, label: "Support microtonal notation", help: "Enables experimental makam/perde/EDO-53 tools, including Intonation Explorer and Bolahenk/concert conversion.", ui: { input: "checkbox" }, advanced: true },
  ...
  { key: "libraryRichTooltips", type: "boolean", default: true, section: "Library", group: "Interface", groupOrder: 20, label: "Show detailed Library tooltips", help: "Show file, group, and tune metadata when hovering over Library entries.", ui: { input: "checkbox" } },
